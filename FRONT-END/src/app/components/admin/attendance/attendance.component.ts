...
const endpoint = `${environment.SERVER_URL}api/attendances/filtered`;
...
export class AttendanceComponent implements OnInit {
  ...
  getStudentsDetails() {
    const url = `${environment.SERVER_URL}api/students/${this.loginIUserId._id}/details`;
  ...
  getSpecificStudentsDetailsFromParent(studentId: any) {
    const url = `${environment.SERVER_URL}api/students/${studentId}/details`;
    this.http.get(url, httpOption).subscribe(
      (response: any) => {
        console.log(response);
        this.name =
  ...
  getSingleParent() {
    ...
    const url = `${environment.SERVER_URL}api/parents/${this.loginIUserId._id}/details`;
    this.http.get(url, httpOption).subscribe(
      (response: any) => {
        console.log(response);
