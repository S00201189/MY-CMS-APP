...
const endpoint = `${environment.SERVER_URL}api/students`;
...
export class TeacherStudentsComponent implements OnInit {
  ...
  getDepartments() {
    const endpoints = `${environment.SERVER_URL}api/departments`;
  ...
  createStudent() {
    const endpoints = `${environment.SERVER_URL}api/students/create`;
  ...
  getStudents() {
    const url = `${environment.SERVER_URL}api/students`;
  ...
  updateStudent() {
    const endpoints = `${environment.SERVER_URL}api/students/${this.updatedId}`;
  ...
  remove(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const endpoints = `${environment.SERVER_URL}api/students/${id}`;
