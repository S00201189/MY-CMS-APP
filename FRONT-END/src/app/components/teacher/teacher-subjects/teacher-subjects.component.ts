...
const endpoint = `${environment.SERVER_URL}api/subjects`;
...
export class TeacherSubjectsComponent implements OnInit {
  ...
  createSubject() {
    const endpoints = `${environment.SERVER_URL}api/subjects/create`;
  ...
  getSubjects() {
    const url = `${environment.SERVER_URL}api/subjects`;
  ...
  updateSubject() {
    const endpoints = `${environment.SERVER_URL}api/subjects/${this.updatedId}`;
  ...
  remove(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const endpoints = `${environment.SERVER_URL}api/subjects/${id}`;
