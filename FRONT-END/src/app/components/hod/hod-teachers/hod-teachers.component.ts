...
const endpoint = `${environment.SERVER_URL}api/teachers`;
...
export class HodTeachersComponent implements OnInit {
  ...
  getTeachers() {
    const url = `${environment.SERVER_URL}api/teachers`;
  ...
  createTeacher() {
    const endpoints = `${environment.SERVER_URL}api/teachers/create`;
  ...
  updateTeachers() {
    const endpoints = `${environment.SERVER_URL}api/teachers/${this.updatedId}`;
  ...
  remove(id: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const endpoints = `${environment.SERVER_URL}api/teachers/${id}`;
